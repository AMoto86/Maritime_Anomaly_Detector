...
LOCAL VERSION - Contains API key for local deployment only.
...
class WebSocketConfig:
    ...
    # Local deployment: API key is set here for convenience.
    # For production/public repos, use environment variables instead.
    api_key: str = os.getenv("AIS_API_KEY", "5b4c49bed156e0c9c100667f12876416086f7849")
